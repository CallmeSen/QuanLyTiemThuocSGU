...
VALUES 
('Tran Quang Huy', 'M', '0901234567', 'huytq@pharmacy.com', 8500000, '2021-05-01'),
('Nguyen Thi Lan', 'F', '0902345678', 'lannn@pharmacy.com', 9200000, '2020-11-15'),
('Le Van Khoa', 'M', '0903456789', 'khoalv@pharmacy.com', 7500000, '2022-02-10'),
('Pham Minh Anh', 'F', '0904567890', 'anhtp@pharmacy.com', 6800000, '2023-03-20');
GO

-- Chèn dữ liệu giả cho bảng Accounts
INSERT INTO Accounts (Username, Password, Role, EmployeeID)
VALUES 
('huy_tran', 'huy_password123', 1, 1),
('lan_nguyen', 'lan_password456', 2, 2),
('khoa_le', 'khoa_password789', 1, 3),
('minh_anh', 'anh_password321', 2, 4);
GO
